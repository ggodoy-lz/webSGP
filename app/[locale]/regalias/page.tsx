        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-display font-black text-[#212226] text-4xl lg:text-5xl mb-4">
                {t("convenios.title")}
              </h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[{n:"IFPI",c:"#f0552f"},{n:"WIPO",c:"#4666a6"}].map(({n,c}) => (
                <div key={n} className="flex items-center justify-center py-16 hover:opacity-90 transition-opacity" style={{backgroundColor:c}}>
      ...
      <section className="bg-[#212226] py-20">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            ...
            <h2 className="font-display font-black text-white text-4xl lg:text-5xl">{t("cta.title")}</h2>
